package cinema.app.cinemaapp.view.customview
...
class ReadMoreTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    init {
        ...
        this.trimLines = typedArray.getInt(
            R.styleable.ReadMoreTextView_trimLines,
            DEFAULT_TRIM_LINES
        )
        ...
        this.trimMode = typedArray.getInt(
            R.styleable.ReadMoreTextView_trimMode,
            TRIM_MODE_LINES
        )
        typedArray.recycle()
